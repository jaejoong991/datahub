...
describe("FollowPrizeManager", () => {
    ...
    describe("deleteFollowPrize", () => {
        it("should delete a follow prize", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/follow_prize/delete_follow_prize", {
                method: "POST",
                auth: true,
                body: {
                    campaign_id: 24255,
    ...
    describe("getFollowPrizeDetail", () => {
        it("should get follow prize detail with fix amount discount", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/follow_prize/get_follow_prize_detail", {
                method: "GET",
                auth: true,
                params: {
                    campaign_id: 1551,
    ...
    describe("getFollowPrizeList", () => {
        it("should get list of upcoming follow prizes", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/follow_prize/get_follow_prize_list", {
                method: "GET",
                auth: true,
                params: {
                    status: FollowPrizeStatus.UPCOMING,
    ...
    describe("updateFollowPrize", () => {
        it("should update a follow prize", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/follow_prize/update_follow_prize", {
                method: "POST",
                auth: true,
                body: {
                    campaign_id: 3434334,
...
//# sourceMappingURL=follow-prize.manager.test.js.map