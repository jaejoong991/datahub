...
import { ShopFlashSaleStatus, ShopFlashSaleType, ShopFlashSaleItemStatus, } from "../../schemas/shop-flash-sale.js";
// Mock ShopeeFetch.fetch static method
const mockFetch = jest.fn();
ShopeeFetch.fetch = mockFetch;
describe("ShopFlashSaleManager", () => {
    let shopFlashSaleManager;
    let mockConfig;
    ...
    describe("getTimeSlotId", () => {
        it("should get available time slot IDs", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/get_time_slot_id", {
                method: "GET",
                auth: true,
                params: {
                    start_time: 1721978628,
    ...
    describe("createShopFlashSale", () => {
        it("should create a new shop flash sale", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/create_shop_flash_sale", {
                method: "POST",
                auth: true,
                body: {
                    timeslot_id: 236767490043904,
    ...
    describe("getShopFlashSale", () => {
        it("should get shop flash sale details", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/get_shop_flash_sale", {
                method: "GET",
                auth: true,
                params: {
                    flash_sale_id: 802063533822541,
    ...
    describe("getShopFlashSaleList", () => {
        it("should get shop flash sale list", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/get_shop_flash_sale_list", {
                method: "GET",
                auth: true,
                params: {
                    type: 1,
    ...
    describe("updateShopFlashSale", () => {
        it("should update shop flash sale status", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/update_shop_flash_sale", {
                method: "POST",
                auth: true,
                body: {
                    flash_sale_id: 802053471670861,
    ...
    describe("deleteShopFlashSale", () => {
        it("should delete shop flash sale", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/delete_shop_flash_sale", {
                method: "POST",
                auth: true,
                body: {
                    flash_sale_id: 802053515727437,
    ...
    describe("addShopFlashSaleItems", () => {
        it("should add items to shop flash sale", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/add_shop_flash_sale_items", {
                method: "POST",
                auth: true,
                body: {
                    flash_sale_id: 802063533822541,
    ...
    describe("getShopFlashSaleItems", () => {
        it("should get shop flash sale items", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/get_shop_flash_sale_items", {
                method: "GET",
                auth: true,
                params: {
                    flash_sale_id: 802063533822541,
    ...
    describe("updateShopFlashSaleItems", () => {
        it("should update shop flash sale items", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/update_shop_flash_sale_items", {
                method: "POST",
                auth: true,
                body: {
                    flash_sale_id: 802063533822541,
    ...
    describe("deleteShopFlashSaleItems", () => {
        it("should delete items from shop flash sale", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/delete_shop_flash_sale_items", {
                method: "POST",
                auth: true,
                body: {
                    flash_sale_id: 802063533822541,
    ...
    describe("getItemCriteria", () => {
        it("should get item criteria for shop flash sale", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_flash_sale/get_item_criteria", {
                method: "GET",
                auth: true,
                params: {},
            });
...
//# sourceMappingURL=shop-flash-sale.manager.test.js.map