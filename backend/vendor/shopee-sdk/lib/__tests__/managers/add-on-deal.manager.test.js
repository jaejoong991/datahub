...
import { AddOnDealPromotionType, AddOnDealPromotionStatus, AddOnDealMainItemStatus, AddOnDealSubItemStatus, } from "../../schemas/add-on-deal.js";
// Mock ShopeeFetch.fetch static method
const mockFetch = jest.fn();
ShopeeFetch.fetch = mockFetch;
describe("AddOnDealManager", () => {
    let addOnDealManager;
    let mockConfig;
    ...
    describe("addAddOnDealMainItem", () => {
        it("should add main items to an add-on deal", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/add_on_deal/add_add_on_deal_main_item", {
                method: "POST",
                auth: true,
                body: {
                    add_on_deal_id: 20141,
    ...
    describe("addAddOnDealSubItem", () => {
        it("should add sub items to an add-on deal", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/add_on_deal/add_add_on_deal_sub_item", {
                method: "POST",
                auth: true,
                body: {
                    add_on_deal_id: 20141,
    ...
    describe("deleteAddOnDealMainItem", () => {
        it("should delete main items from an add-on deal", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/add_on_deal/delete_add_on_deal_main_item", {
                method: "POST",
                auth: true,
                body: {
                    add_on_deal_id: 20141,
    ...
    describe("deleteAddOnDealSubItem", () => {
        it("should delete sub items from an add-on deal", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/add_on_deal/delete_add_on_deal_sub_item", {
                method: "POST",
                auth: true,
                body: {
                    add_on_deal_id: 20141,
    ...
    describe("getAddOnDealList", () => {
        it("should get a list of add-on deals", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/add_on_deal/get_add_on_deal_list", {
                method: "GET",
                auth: true,
                params: {
                    promotion_status: AddOnDealPromotionStatus.ALL,
    ...
    describe("getAddOnDealMainItem", () => {
        it("should get main items in an add-on deal", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/add_on_deal/get_add_on_deal_main_item", {
                method: "GET",
                auth: true,
                params: {
                    add_on_deal_id: 20141,
    ...
    describe("getAddOnDealSubItem", () => {
        it("should get sub items in an add-on deal", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/add_on_deal/get_add_on_deal_sub_item", {
                method: "GET",
                auth: true,
                params: {
                    add_on_deal_id: 20141,
    ...
    describe("updateAddOnDealMainItem", () => {
        it("should update main items in an add-on deal", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/add_on_deal/update_add_on_deal_main_item", {
                method: "POST",
                auth: true,
                body: {
                    add_on_deal_id: 20141,
    ...
    describe("updateAddOnDealSubItem", () => {
        it("should update sub items in an add-on deal", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/add_on_deal/update_add_on_deal_sub_item", {
                method: "POST",
                auth: true,
                body: {
                    add_on_deal_id: 20141,
...
//# sourceMappingURL=add-on-deal.manager.test.js.map