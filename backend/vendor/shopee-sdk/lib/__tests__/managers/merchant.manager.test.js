...
describe("MerchantManager", () => {
    ...
    describe("getMerchantPrepaidAccountList", () => {
        it("should get merchant prepaid account list", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/merchant/get_merchant_prepaid_account_list", {
                method: "GET",
                auth: true,
                params: {
                    page_no: 1,
    ...
    describe("getMerchantWarehouseList", () => {
        it("should get merchant warehouse list", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/merchant/get_merchant_warehouse_list", {
                method: "POST",
                auth: true,
                body: {
                    cursor: {
    ...
    describe("getMerchantWarehouseLocationList", () => {
        it("should get merchant warehouse location list", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/merchant/get_merchant_warehouse_location_list", {
                method: "GET",
                auth: true,
                params: undefined,
            });
    ...
    describe("getShopListByMerchant", () => {
        it("should get shop list bound to merchant", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/merchant/get_shop_list_by_merchant", {
                method: "GET",
                auth: true,
                params: {
                    page_no: 1,
    ...
    describe("getWarehouseEligibleShopList", () => {
        it("should get eligible shop list by warehouse id", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/merchant/get_warehouse_eligible_shop_list", {
                method: "POST",
                auth: true,
                body: {
                    warehouse_id: 10001027,
...
//# sourceMappingURL=merchant.manager.test.js.map