...
describe("MediaSpaceManager", () => {
    ...
    describe("uploadVideoPart", () => {
        ...
        it("should upload multiple video parts in sequence", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenNthCalledWith(3, mockConfig, "/media_space/upload_video_part", {
                method: "POST",
                body: {
                    video_upload_id: "sg_test_upload_id",
                    part_seq: 2,
    ...
    describe("completeVideoUpload", () => {
        ...
        it("should complete video upload with multiple parts", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/media_space/complete_video_upload", expect.objectContaining({
                method: "POST",
...
//# sourceMappingURL=media-space.manager.test.js.map