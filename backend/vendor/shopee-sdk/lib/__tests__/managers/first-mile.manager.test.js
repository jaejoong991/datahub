...
describe("FirstMileManager", () => {
    ...
    describe("generateFirstMileTrackingNumber", () => {
        it("should generate first mile tracking number", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/generate_first_mile_tracking_number", {
                method: "POST",
                auth: true,
                body: {
                    declare_date: "2024-01-15",
    ...
    describe("bindFirstMileTrackingNumber", () => {
        it("should bind first mile tracking number", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/bind_first_mile_tracking_number", {
                method: "POST",
                auth: true,
                body: {
                    first_mile_tracking_number: "CNF731738838434210105",
    ...
    describe("unbindFirstMileTrackingNumber", () => {
        it("should unbind first mile tracking number", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/unbind_first_mile_tracking_number", {
                method: "POST",
                auth: true,
                body: {
                    first_mile_tracking_number: "CNF731738838434210105",
    ...
    describe("getTrackingNumberList", () => {
        it("should get tracking number list", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/get_tracking_number_list", {
                method: "GET",
                auth: true,
                params: {
                    from_date: "2024-01-01",
    ...
    describe("getUnbindOrderList", () => {
        it("should get unbind order list", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/get_unbind_order_list", {
                method: "GET",
                auth: true,
                params: {
                    page_size: 20,
    ...
    describe("getCourierDeliveryChannelList", () => {
        it("should get courier delivery channel list", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/get_courier_delivery_channel_list", {
                method: "GET",
                auth: true,
                params: {
                    region: "CN",
    ...
    describe("getTransitWarehouseList", () => {
        it("should get transit warehouse list", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/get_transit_warehouse_list", {
                method: "GET",
                auth: true,
                params: undefined,
            });
    ...
    describe("generateAndBindFirstMileTrackingNumber", () => {
        it("should generate and bind first mile tracking number", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/generate_and_bind_first_mile_tracking_number", {
                method: "POST",
                auth: true,
                body: {
                    shipment_method: "courier_delivery",
    ...
    describe("bindCourierDeliveryFirstMileTrackingNumber", () => {
        it("should bind courier delivery first mile tracking number", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/bind_courier_delivery_first_mile_tracking_number", {
                method: "POST",
                auth: true,
                body: {
                    shipment_method: "courier_delivery",
    ...
    describe("getCourierDeliveryDetail", () => {
        it("should get courier delivery detail", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/get_courier_delivery_detail", {
                method: "GET",
                auth: true,
                params: {
                    binding_id: "BINDING123456",
    ...
    describe("getCourierDeliveryTrackingNumberList", () => {
        it("should get courier delivery tracking number list", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/get_courier_delivery_tracking_number_list", {
                method: "POST",
                auth: true,
                body: {
                    from_date: "2024-01-01",
    ...
    describe("getCourierDeliveryWaybill", () => {
        it("should get courier delivery waybill", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/get_courier_delivery_waybill", {
                method: "POST",
                auth: true,
                body: {
                    binding_id_list: ["BINDING123456"],
    ...
    describe("unbindFirstMileTrackingNumberAll", () => {
        it("should unbind all first mile tracking numbers", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/first_mile/unbind_first_mile_tracking_number_all", {
                method: "POST",
                auth: true,
                body: {
                    order_list: [
...
//# sourceMappingURL=first-mile.manager.test.js.map