...
import { BundleDealRuleType, BundleDealTimeStatus, } from "../../schemas/bundle-deal.js";
// Mock ShopeeFetch.fetch static method
const mockFetch = jest.fn();
ShopeeFetch.fetch = mockFetch;
describe("BundleDealManager", () => {
    let bundleDealManager;
    let mockConfig;
    ...
    describe("addBundleDealItem", () => {
        it("should add items to a bundle deal", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/bundle_deal/add_bundle_deal_item", {
                method: "POST",
                auth: true,
                body: {
                    bundle_deal_id: 11111,
    ...
    describe("getBundleDealItem", () => {
        it("should get bundle deal items", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/bundle_deal/get_bundle_deal_item", {
                method: "GET",
                auth: true,
                params: {
                    bundle_deal_id: 11111,
    ...
    describe("getBundleDealList", () => {
        it("should get bundle deal list with default params", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/bundle_deal/get_bundle_deal_list", {
                method: "GET",
                auth: true,
                params: {},
            });
...
//# sourceMappingURL=bundle-deal.manager.test.js.map