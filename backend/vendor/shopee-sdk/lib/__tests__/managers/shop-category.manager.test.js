...
describe("ShopCategoryManager", () => {
    ...
    describe("getShopCategoryList", () => {
        it("should get list of shop categories", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_category/get_shop_category_list", {
                method: "GET",
                auth: true,
                params: {
                    page_size: 100,
    ...
    describe("updateShopCategory", () => {
        it("should update a shop category", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_category/update_shop_category", {
                method: "POST",
                auth: true,
                body: {
                    shop_category_id: 29333,
    ...
    describe("deleteShopCategory", () => {
        it("should delete a shop category", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop_category/delete_shop_category", {
                method: "POST",
                auth: true,
                body: {
                    shop_category_id: 9209570,
...
//# sourceMappingURL=shop-category.manager.test.js.map