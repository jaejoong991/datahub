...
describe("ShopManager", () => {
    ...
    describe("getAuthorisedResellerBrand", () => {
        it("should get authorised reseller brand successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop/get_authorised_reseller_brand", {
                method: "GET",
                auth: true,
                params: {
                    page_no: 1,
    ...
    describe("getBRShopOnboardingInfo", () => {
        it("should get BR shop onboarding info successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/shop/get_br_shop_onboarding_info", {
                method: "GET",
                auth: true,
                params: {},
            });
...
//# sourceMappingURL=shop.manager.test.js.map