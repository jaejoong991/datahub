...
describe("AdsManager", () => {
    ...
    describe("getRecommendedKeywordList", () => {
        it("should get recommended keyword list successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_recommended_keyword_list", {
                method: "GET",
                auth: true,
                params: {
                    item_id: 123456,
    ...
    describe("getAllCpcAdsHourlyPerformance", () => {
        it("should get hourly performance data successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_all_cpc_ads_hourly_performance", {
                method: "GET",
                auth: true,
                params: {
                    performance_date: "01-01-2021",
    ...
    describe("getAllCpcAdsDailyPerformance", () => {
        it("should get daily performance data successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_all_cpc_ads_daily_performance", {
                method: "GET",
                auth: true,
                params: {
                    start_date: "2021-01-01",
    ...
    describe("getProductCampaignDailyPerformance", () => {
        it("should get product campaign daily performance successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_product_campaign_daily_performance", {
                method: "GET",
                auth: true,
                params: {
                    start_date: "2021-01-01",
    ...
    describe("getProductCampaignHourlyPerformance", () => {
        it("should get product campaign hourly performance successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_product_campaign_hourly_performance", {
                method: "GET",
                auth: true,
                params: {
                    performance_date: "2021-01-01",
    ...
    describe("getProductLevelCampaignIdList", () => {
        it("should get product level campaign ID list successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_product_level_campaign_id_list", {
                method: "GET",
                auth: true,
            });
            expect(result.error).toBe("");
    ...
    describe("getProductLevelCampaignSettingInfo", () => {
        it("should get product level campaign setting info successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_product_level_campaign_setting_info", {
                method: "GET",
                auth: true,
                params: {
                    info_type_list: "1",
    ...
    describe("getProductRecommendedRoiTarget", () => {
        it("should get product recommended ROI target successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_product_recommended_roi_target", {
                method: "GET",
                auth: true,
                params: {
                    item_id: 123456,
    ...
    describe("checkCreateGmsProductCampaignEligibility", () => {
        it("should check eligibility successfully when eligible", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/check_create_gms_product_campaign_eligibility", {
                method: "GET",
                auth: true,
            });
            expect(result.error).toBe("");
    ...
    describe("editGmsItemProductCampaign", () => {
        it("should add items to GMS campaign successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/edit_gms_item_product_campaign", {
                method: "POST",
                auth: true,
                body: {
                    campaign_id: 111222,
    ...
    describe("editManualProductAdKeywords", () => {
        it("should add keywords to manual product ads successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/edit_manual_product_ad_keywords", {
                method: "POST",
                auth: true,
                body: {
                    reference_id: "keyword-ref-001",
    ...
    describe("getCreateProductAdBudgetSuggestion", () => {
        it("should get budget suggestion for auto product ads", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_create_product_ad_budget_suggestion", {
                method: "GET",
                auth: true,
                params: {
                    reference_id: "budget-ref-001",
    ...
    describe("getGmsCampaignPerformance", () => {
        it("should get GMS campaign performance successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/ads/get_gms_campaign_performance", {
                method: "POST",
                auth: true,
                body: {
                    campaign_id: 111222,
...
//# sourceMappingURL=ads.manager.test.js.map