...
import { MetricType, MetricUnit, PerformanceRating, } from "../../schemas/account-health.js";
// Mock ShopeeFetch.fetch static method
const mockFetch = jest.fn();
ShopeeFetch.fetch = mockFetch;
describe("AccountHealthManager", () => {
    let accountHealthManager;
    let mockConfig;
    ...
    describe("getShopPerformance", () => {
        it("should get shop performance metrics successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/account_health/get_shop_performance", {
                method: "GET",
                auth: true,
            });
    ...
    describe("getMetricSourceDetail", () => {
        it("should get metric source details for NFR successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/account_health/get_metric_source_detail", {
                method: "GET",
                auth: true,
                params: {
                    metric_id: 3,
    ...
    describe("getPenaltyPointHistory", () => {
        it("should get penalty point history successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/account_health/get_penalty_point_history", {
                method: "GET",
                auth: true,
                params: {
                    page_size: 10,
    ...
    describe("getPunishmentHistory", () => {
        it("should get punishment history successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/account_health/get_punishment_history", {
                method: "GET",
                auth: true,
                params: {
                    punishment_status: 1,
    ...
    describe("getListingsWithIssues", () => {
        it("should get listings with issues successfully", async () => {
            ...
            expect(mockShopeeFetch).toHaveBeenCalledWith(mockConfig, "/account_health/get_listings_with_issues", {
                method: "GET",
                auth: true,
                params: {
                    page_size: 10,
...
//# sourceMappingURL=account-health.manager.test.js.map